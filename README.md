...
The learning, the review, the cards, and the game.

## PyTrek'ers?

Yet here is the introduction to our [PyTrek Pythoneering Mission](https://youtu.be/dRoMF2orxew?si=05S5516Mt04OaxCa).

How to play [PyTrek](https://www.youtube.com/watch?v=VLEXHtqKKaA&t=16s).

And don't forget the [PyQuest](https://github.com/Python3-Training/PyQuest).
